...
private val adapterTarefas1: AdapterTarefas
    get() {
        val adapterTarefas = AdapterTarefas()
        return adapterTarefas
    }
...
class ListaTarefasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private val adapterTarefas = AdapterTarefas()
